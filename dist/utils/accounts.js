...
async function ValorAccount(config) {
    ...
    if (!_save) {
        const ValDatabase = await (0, database_1.ValorDatabase)({
            name: 'account',
        ...
        if (ValDatabase.isFind === true) {
            ...
            const MyWebClient = await web_client_1.Client.fromCookie((0, crypto_1.decrypt)(_OnlyOne.account, config.apiKey), { region: _OnlyOne.region });
