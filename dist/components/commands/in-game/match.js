...
const __command = {
    command: (new discord_js_1.SlashCommandBuilder()
        ...
        .addChoices({ name: lib_1.QueueId.fromString('competitive'), value: lib_1.QueueId.toString('Competitive') }, { name: lib_1.QueueId.from['deathmatch'], value: lib_1.QueueId.to.Deathmatch }, { name: lib_1.QueueId.from['ggteam'], value: lib_1.QueueId.to.Escalation }, { name: lib_1.QueueId.from['onefa'], value: lib_1.QueueId.to.Replication }, { name: lib_1.QueueId.from['snowball'], value: lib_1.QueueId.to.Snowball_Fight }, { name: lib_1.QueueId.from['spikerush'], value: lib_1.QueueId.to.Spikerush }, { name: lib_1.QueueId.from['unrated'], value: lib_1.QueueId.to.Unrated }))),
    category: 'valorant',
    echo: {
        data: [
            'matchhistory'
