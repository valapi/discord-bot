...
exports.default = {
    ...
    execute({ interaction, language, apiKey, DiscordClient, createdTime }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const PlayerCard = yield (new valorant_api_com_1.Client()).PlayerCards.getByUuid(PlayerCard_ID);
            ...
            const PlayerTitle = yield (new valorant_api_com_1.Client()).PlayerTitles.getByUuid(PlayerTitle_ID);
